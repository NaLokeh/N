...
static CV_PossibleValue_t frameinterpolation_cons_t[] = {{0, "Off"}, {1, "On, capped"}, {2, "Uncapped"}, {0, NULL}};
consvar_t cv_frameinterpolation = CVAR_INIT ("frameinterpolation", "On, capped", CV_SAVE, frameinterpolation_cons_t, NULL);
